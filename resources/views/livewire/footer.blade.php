        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16 text-center md:text-left">
            ...
            <div class="col-span-1 md:col-span-1 flex flex-col items-center md:items-start">
                ...
                <div class="mt-8 flex space-x-4">
                    <!-- Social icons -->
                    <a href="https://www.facebook.com/pruvarestaurantkas" target="_blank" class="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:text-brand-olive hover:border-brand-olive transition-colors">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="http://instagram.com/pruvarestaurantkas/" target="_blank" class="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:text-brand-olive hover:border-brand-olive transition-colors">
            ...
            <div class="col-span-1">
                <h3 class="text-brand-olive uppercase tracking-widest text-sm font-semibold mb-6">{{ __('Visit Us') }}</h3>
                 <address class="not-italic text-sm text-gray-600 font-light space-y-4 leading-relaxed">
                    <p class="hover:text-brand-dark transition">{{ App\Models\Setting::getValue('address', 'Andifli, Hastane Cd. No:11, 07580 Kaş/Antalya') }}</p>
            ...
            <div class="col-span-1">
                ...
                <div class="text-sm text-gray-600 font-light space-y-2">
                    ...
                    <p class="pt-6 text-xs text-brand/80 max-w-[200px] mx-auto md:mx-0 leading-relaxed uppercase tracking-wider">{{ __('For special events, please contact us.') }}</p>
                </div>
            </div>
        </div>
